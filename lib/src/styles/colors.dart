...
abstract class AppColors {
  ...
  static Color get white => const Color.fromRGBO(255, 255, 255, 0.1);
  ...
  static Color get instagram => const Color.fromRGBO(233, 89, 80, 1.0);

  static Color get twitter => const Color.fromRGBO(85, 172, 238, 1.0);
